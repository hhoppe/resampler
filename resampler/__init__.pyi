...
def _get_precision(precision: _DTypeLike | None, dtypes: list[_DType], weight_dtypes: list[_DType], /) -> _DType: ...
...
def _make_sparse_matrix(data: _NDArray, row_ind: _NDArray, col_ind: _NDArray, shape: tuple[int, int], arraylib: str, /) -> Any: ...
...
def _split_array_into_blocks(array: _AnyArray, block_shape: Sequence[int], start_axis: int = ...) -> Any: ...
...
def _create_resize_matrix(src_size: int, dst_size: int, src_gridtype: Gridtype, dst_gridtype: Gridtype, boundary: Boundary, filter: Filter, prefilter: Filter | None = ..., scale: float = ..., translate: float = ..., dtype: _DTypeLike = ..., arraylib: str = ...) -> tuple[Any, _AnyArray | None]: ...
...
def _resize_possibly_in_arraylib(array: _AnyArray, /, *args: Any, arraylib: str, **kwargs: Any) -> _AnyArray: ...
