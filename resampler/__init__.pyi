...
def _create_resize_matrix(src_size: int, dst_size: int, src_gridtype: Gridtype, dst_gridtype: Gridtype, boundary: Boundary, filter: Filter, prefilter: Filter | None = ..., scale: float = ..., translate: float = ..., dtype: _DTypeLike = ..., arraylib: str = ...) -> tuple[_Array, _Array | None]: ...
