...
def resize(array: _Array, shape: Iterable[int], *, gridtype: Union[str, Gridtype, None] = ..., src_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., dst_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., boundary: Union[str, Boundary, Iterable[Union[str, Boundary]]] = ..., cval: _ArrayLike = ..., filter: Union[str, Filter, Iterable[Union[str, Filter]]] = ..., prefilter: Union[str, Filter, Iterable[Union[str, Filter]], None] = ..., gamma: Union[str, Gamma, None] = ..., src_gamma: Union[str, Gamma, None] = ..., dst_gamma: Union[str, Gamma, None] = ..., scale: Union[float, Iterable[float]] = ..., translate: Union[float, Iterable[float]] = ..., precision: _DTypeLike = ..., dtype: _DTypeLike = ..., dim_order: Union[Iterable[int], None] = ...) -> _Array: ...
...
def uniform_resize(array: _Array, shape: Iterable[int], *, gridtype: Union[str, Gridtype, None] = ..., src_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., dst_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., boundary: Union[str, Boundary, Iterable[Union[str, Boundary]]] = ..., scale: Union[float, Iterable[float]] = ..., translate: Union[float, Iterable[float]] = ..., **kwargs: Any) -> _Array: ...
def resample(array: _Array, coords: _ArrayLike, *, gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]]] = ..., boundary: Union[str, Boundary, Iterable[Union[str, Boundary]]] = ..., cval: _ArrayLike = ..., filter: Union[str, Filter, Iterable[Union[str, Filter]]] = ..., prefilter: Union[str, Filter, Iterable[Union[str, Filter]], None] = ..., gamma: Union[str, Gamma, None] = ..., src_gamma: Union[str, Gamma, None] = ..., dst_gamma: Union[str, Gamma, None] = ..., jacobian: Union[_ArrayLike, None] = ..., precision: _DTypeLike = ..., dtype: _DTypeLike = ..., max_block_size: int = ..., debug: bool = ...) -> _Array: ...
def resample_affine(array: _Array, shape: Iterable[int], matrix: _ArrayLike, *, gridtype: Union[str, Gridtype, None] = ..., src_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., dst_gridtype: Union[str, Gridtype, Iterable[Union[str, Gridtype]], None] = ..., filter: Union[str, Filter, Iterable[Union[str, Filter]]] = ..., prefilter: Union[str, Filter, Iterable[Union[str, Filter]], None] = ..., precision: _DTypeLike = ..., dtype: _DTypeLike = ..., **kwargs: Any) -> _Array: ...
def rotation_about_center_in_2d(src_shape: _ArrayLike, angle: float, *, new_shape: Union[_ArrayLike, None] = ..., scale: float = ...) -> _NDArray: ...
def rotate_image_about_center(image: _NDArray, angle: float, *, new_shape: Union[_ArrayLike, None] = ..., scale: float = ..., num_rotations: int = ..., **kwargs: Any) -> _NDArray: ...
...
def scipy_ndimage_resize(array: _ArrayLike, shape: Iterable[int], *, filter: str, boundary: str = ..., cval: float = ...) -> _NDArray: ...
def skimage_transform_resize(array: _ArrayLike, shape: Iterable[int], *, filter: str, boundary: str = ..., cval: float = ...) -> _NDArray: ...
def tf_image_resize(array: _ArrayLike, shape: Iterable[int], *, filter: str, antialias: bool = ...) -> _TensorflowTensor: ...
def torch_nn_resize(array: _ArrayLike, shape: Iterable[int], *, filter: str, antialias: bool = ...) -> _TorchTensor: ...
def jax_image_resize(array: _ArrayLike, shape: Iterable[int], *, filter: str, scale: Union[float, Iterable[float]] = ..., translate: Union[float, Iterable[float]] = ...) -> _JaxArray: ...
